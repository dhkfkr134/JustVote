                ...
                <RBS.Navbar.Collapse id="responsive-navbar-nav">
                    <RBS.Nav className="mr-auto">
                        ...
                        <RBS.NavDropdown title="Introduce" id="collasible-nav-dropdown">
                            <RBS.NavDropdown.Item href="Introduce/3.1">연혁</RBS.NavDropdown.Item>
                            <RBS.NavDropdown.Item href="Introduce/3.2">목표</RBS.NavDropdown.Item>
                            <RBS.NavDropdown.Item href="Introduce/3.3">시부럴 ㅋ</RBS.NavDropdown.Item>
                            <RBS.NavDropdown.Divider />
                            <RBS.NavDropdown.Item href="Introduce/3.4">선으로 나눌수 있는거 보여줌</RBS.NavDropdown.Item>
                        </RBS.NavDropdown>
                    </RBS.Nav>
                    <RBS.Nav>
                        <RBS.Nav.Link href="/SignUp">Sign up</RBS.Nav.Link>
                        <RBS.Nav.Link eventKey={2} href="/SignIn">Sign in</RBS.Nav.Link>
                    </RBS.Nav>
                    <RBS.Form inline>
